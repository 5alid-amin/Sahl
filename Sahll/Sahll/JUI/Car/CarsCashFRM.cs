...
namespace Sahll.JUI.Car
{
    public partial class CarsCashFRM : Form
    {
        public CarsCashFRM()
        {
            ...
            dgvcarcash.Rows.Add(new object[] { "الخمسي", "28/12/2004", 23156 });
            dgvcarcash.Rows.Add(new object[] { "الثلاثاء", "28/12/2004", 2156 });
            dgvcarcash.Rows.Add(new object[] { "الخمسي", "28/12/2004", 23156 });
            dgvcarcash.Rows.Add(new object[] { "الثلاثاء", "28/12/2004", 2156 });
            dgvcarcash.Rows.Add(new object[] { "الخمسي", "28/12/2004", 23156 });
            dgvcarcash.Rows.Add(new object[] { "الثلاثاء", "28/12/2004", 2156 });
            ...
            if (e.ColumnIndex >= 0 && e.RowIndex >= 0 && dgvcarcash.Columns[e.ColumnIndex] is DataGridViewImageColumn)
            {
                ...
                switch (columnName)
                {
                    ...
                    case "edit":
                        ...
                        frm.lblCarsAddEditCashFRM.Text = "تعديل النقديه";
                        frm.Show();
        ...
        {
            var title = $"تقرير بالنقديه المحصله للسياره ليوم {DateTime.Now:dddd} بتاريخ {DateTime.Now:yyyy-MM-dd}";
            ...
            string salesReportsFolder = Path.Combine(cars, "النقديه المحصله");
            ...
            {
                var worksheet = workbook.Worksheets.Add("تحصيل النقديه");
