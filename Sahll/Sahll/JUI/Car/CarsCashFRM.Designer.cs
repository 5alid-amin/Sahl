namespace Sahll.JUI.Car
{
    partial class CarsCashFRM
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3 = new Label();
            pnlcarcash.SuspendLayout();
            khPanel1.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)dgvcarcash).BeginInit();
            SuspendLayout();
            // 
            // pnlcarcash
            // 
            ...
            pnlcarcash.Controls.Add(lbltotal);
            pnlcarcash.Controls.Add(khButton1);
            pnlcarcash.Controls.Add(khPanel1);
            pnlcarcash.Controls.Add(DpFromCash);
            pnlcarcash.Controls.Add(label1);
            pnlcarcash.Controls.Add(btncar3);
            pnlcarcash.Controls.Add(khButton2);
            pnlcarcash.Controls.Add(btncar4);
            pnlcarcash.Controls.Add(btncar2);
            pnlcarcash.Controls.Add(btncar1);
            pnlcarcash.Controls.Add(btncar5);
            pnlcarcash.Controls.Add(txtsearch);
            pnlcarcash.Controls.Add(khButton3);
            pnlcarcash.Controls.Add(label3);
            ...
            // DpToCash
            // 
            DpToCash.Anchor = AnchorStyles.Right;
            DpToCash.BorderColor = Color.White;
            ...
            DpToCash.SkinColor = Color.Transparent;
            DpToCash.TabIndex = 75;
            DpToCash.TextColor = Color.FromArgb(63, 36, 114);
            // 
            // btnAddCash
            // 
            btnAddCash.Anchor = AnchorStyles.None;
            btnAddCash.BackColor = Color.FromArgb(173, 109, 209);
            btnAddCash.BackgroundColor = Color.FromArgb(173, 109, 209);
            btnAddCash.BorderColor = Color.FromArgb(63, 36, 114);
            btnAddCash.BorderRadius = 40;
            btnAddCash.BorderSize = 0;
            btnAddCash.Cursor = Cursors.Hand;
            btnAddCash.FlatAppearance.BorderSize = 0;
            ...
            khPanel1.Controls.Add(dgvcarcash);
            ...
            // dgvcarcash
            // 
            dgvcarcash.AllowUserToAddRows = false;
            dgvcarcash.AllowUserToDeleteRows = false;
            dgvcarcash.AllowUserToResizeColumns = false;
            dgvcarcash.AllowUserToResizeRows = false;
            dgvcarcash.BackgroundColor = Color.White;
            dgvcarcash.BorderStyle = BorderStyle.None;
            dgvcarcash.CellBorderStyle = DataGridViewCellBorderStyle.None;
            dgvcarcash.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.None;
            ...
            dgvcarcash.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
            dgvcarcash.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dgvcarcash.Columns.AddRange(new DataGridViewColumn[] { day, date, received, delete, edit });
            ...
            dgvcarcash.DefaultCellStyle = dataGridViewCellStyle3;
            dgvcarcash.Dock = DockStyle.Fill;
            dgvcarcash.EnableHeadersVisualStyles = false;
            dgvcarcash.GridColor = Color.White;
            dgvcarcash.Location = new Point(5, 8);
            dgvcarcash.Name = "dgvcarcash";
            dgvcarcash.ReadOnly = true;
            dgvcarcash.RightToLeft = RightToLeft.Yes;
            dgvcarcash.RowHeadersVisible = false;
            dgvcarcash.RowHeadersWidth = 25;
            ...
            dgvcarcash.CellMouseLeave += dgvcarcash_CellMouseLeave;
            // 
            // day
            // 
            day.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            day.FillWeight = 102.037514F;
            day.HeaderText = "اليوم";
            day.Name = "day";
            day.ReadOnly = true;
            // 
            // date
            ...
            received.FillWeight = 51.0187569F;
            received.HeaderText = "الواصل";
            ...
            // DpFromCash
            // 
            DpFromCash.Anchor = AnchorStyles.Right;
            DpFromCash.BorderColor = Color.White;
            ...
            DpFromCash.SkinColor = Color.Transparent;
            DpFromCash.TabIndex = 72;
            DpFromCash.TextColor = Color.FromArgb(63, 36, 114);
            // 
            // label1
            // 
            ...
            label3.Location = new Point(206, 653);
            label3.Name = "label3";
            ...
            ShowInTaskbar = false;
            Text = "carscashFRM";
            pnlcarcash.ResumeLayout(false);
            pnlcarcash.PerformLayout();
            khPanel1.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)dgvcarcash).EndInit();
            ResumeLayout(false);
        }

        #endregion
        private customs.KhControles.KhButton btnaddinventory;
        private customs.KhControles.KhButton khButton9;
        private customs.KhPanel khPanel1;
        private DataGridView dgvcarcash;
        ...
        private customs.KhControles.KhButton btnAddCash;
        private customs.KhControles.KhDatePicker DpToCash;
        private Label label2;
        private customs.KhControles.KhButton khButton1;
        private customs.KhControles.KhDatePicker DpFromCash;
